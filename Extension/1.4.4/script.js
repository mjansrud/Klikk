			...
			switch(response){
				...
				case 'false':
					...
					switch (random){  
						...
						break;
						case 2:
							message = 'Feil, tar den på neste!';
						break;
						case 3:
							message = 'Haff, tullete greier.';
						break;
						case 4:
						...
						break;
						case 8:
							message = 'Feil, men Finken tar deg uansett.'; 
						break;
						case 9:
							message = 'Feil, trenger kanskje noen øl!'; 
						break;
						case 10:
							message = 'Feil, burde lest mer.'; 
						break;
						case 11:
							message = 'Feil, for no skit.'; 
						break;
						case 12:
							message = 'Feil, Morten trenger et liv.'; 
						break;
						case 13:
							message = 'Feil, trist prokastrinering.'; 
						break;
						case 14:
							message = 'Feil, burde kanskje lest skole.'; 
						break;
						case 15:
							message = 'Feil, sjekker nerdekos i stedet.'; 
						break;
						case 16:
							message = 'Feil, kanskje Einstein har svaret.'; 
						break;
						case 17:
							message = 'Feil, tar en pause på kontoret.'; 
						break;
						case 18:
							message = 'Feil, bånner en flaske sprit.'; 
						break;
						case 19:
						...
						break;
						case 21:
							message = "Feil, i'm not smart enough :("; 
						break;
						case 22:
							message = 'Feil, er det egentlig et svar?'; 
						break;
						case 22:
							message = 'Feil, skulle hatt et hint!'; 
						break;
						case 22:
							message = 'Feil, JUST ONE MORE TRY!'; 
						break;
						case 22:
						...
						break;
						case 22:
							message = 'Feil, CAN HAS ANSWER?!'; 
						break;
						case 22:
							message = 'Feil, burde satt NASA på saken.'; 
						break;
						case 22:
							message = 'Feil, burde gjort andre ting.'; 
						break;
						default:
							message = 'Shiiiiiet, scriptet aner ikke hva det skal si.';
						break;
